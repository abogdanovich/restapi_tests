...
def test_compare_post_title(blog_object, test_get_known_id_resource):
    ...
    assert  post_title['title'] == 'sunt aut facere repellat provident occaecati excepturi optio reprehenderit'
...
def test_request_wrong_url(blog_object, test_request_wrong_url_resource):
    ...
    blog_object.log('info', 'test_request_wrong_url: get status code 404 error')
